...
const GUESTS = [
 ...
 {id:'sol',name:'Sol Mercer',short:'Sol',role:'Ex-Cop',img:'guest_vex.svg',hue:155,recipe:'blackout',trust:4,chem:2,mood:'misstrauisch',scenes:[
 ...
 {id:'mira',name:'Mira Quell',short:'Mira',role:'Holo-Sängerin',img:'guest_nyx.svg',hue:78,recipe:'mirage',trust:7,chem:10,mood:'melancholisch',scenes:[
 ...
 {id:'kade',name:'Kade Zero',short:'Kade',role:'Helix-Deserteur',img:'guest_aria.svg',hue:235,recipe:'ghost',trust:2,chem:1,mood:'erschöpft',scenes:[
...
function selectGlass(type){mix.glass=type;$('glass').className=type.toLowerCase();renderGlassSelector();$('mixLog').textContent=`${type}-Glas ausgewählt.`;beep(520,.05)}
